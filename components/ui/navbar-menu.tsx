  ...
  return (
    <div onMouseEnter={() => setActive(item)} className={`relative ${className}`}>
      <motion.div
        ...
        className="cursor-pointer text-neutral-400 hover:text-white hover:opacity-[0.9] dark:text-white"
      >
        {item}
      </motion.div>
      {active !== null && (
              ...
              >
                <motion.div
                 ...
                 { type: "spring",
                  ...
                  className="w-max h-full p-4 px-10 "
                >
                  {children}
                </motion.div>
              </motion.div>
...
export const ProductItem = ({
  ...
  return (
    <Link href={href} className="flex space-x-2 hover:bg-black hover:rounded-md p-2 hover:bg-opacity-10">
      <Image
        src={src}
        width={140}
        height={70}
